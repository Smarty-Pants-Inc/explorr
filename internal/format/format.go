...
//
//	<projectRoot>/.explorr/format.json
//
// and looks like:
//
//	{
...
// ConfigDir is the directory inside a project that holds Explorr's
...
// Load reads and parses the format config at <rootDir>/.explorr/format.json.
